...
new Vue({
  ...
  methods: {
    register: function register() {
      var _this$form_register = this.form_register,
          username = _this$form_register.username,
          email = _this$form_register.email,
          password = _this$form_register.password;
    ...
    login: function login() {
      ...
      var _this$form_login = this.form_login,
          email = _this$form_login.email,
          password = _this$form_login.password; // console.log(email, password);
      ...
      axios({
        ...
        var data = _ref.data;
        console.log(data, 'data client'); // localStorage.setItem('token', data.token)
    ...
    fetchKanban: function fetchKanban() {
      var _this2 = this;
  ...
  computed: {
    backlog: function backlog() {
      var cards = this.cards.filter(function (el) {
