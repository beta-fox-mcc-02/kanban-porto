...
var _default = {
  ...
  data: function data() {
    return {
      ...
      password: '',
      googleSignInParams: {
        client_id: '425308161759-glmhm9ugin8corvgojjurm2u0pd101pf.apps.googleusercontent.com'
      }
    };
  },
  methods: {
    goToSignUp: function goToSignUp(page) {
    ...
    signIn: function signIn() {
      ...
      (0, _axios.default)({
        ...
        _this.$emit('changeIsLogedIn', true);

        _this.$emit('changePage', 'board');
    ...
    onSignInSuccess: function onSignInSuccess(googleUser) {
      ...
      (0, _axios.default)({
        ...
        _this2.$emit('changeIsLogedIn', true);

        _this2.$emit('changePage', 'board');
      }).catch(function (err) {
        console.log(err);
      });
    },
...
exports.default = _default;
        var $e803f5 = exports.default || module.exports;
      
      if (typeof $e803f5 === 'function') {
        $e803f5 = $e803f5.options;
      }
    
        /* template */
        Object.assign($e803f5, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _vm.currentPage === "signIn" && !_vm.isLogedIn
    ? _c("div", { staticClass: "p-2 m-3 form-sign-container" }, [
        _vm._m(0),
        _vm._v(" "),
        _c(
          "form",
          ...
          [
            ...
            _c(
              "div",
              { staticClass: "d-flex align-items-center signInAction" },
              [
                _c("div", { staticClass: "d-flex align-items-center" }, [
                  _c(
                    "button",
                    {
                      ...
                      attrs: { id: "btn-signIn", type: "submit" }
                    },
                    [_vm._v("Sign In")]
                  ),
                  _vm._v(" "),
                  _c(
                    "p",
                    {
                      staticClass: "mb-0 btn-to-signUp",
                      attrs: { id: "btn-to-signUp" },
                      on: {
                        click: function($event) {
                          return _vm.goToSignUp("signUp")
                        }
                      }
                    },
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$e803f5', $e803f5);
          } else {
            api.reload('$e803f5', $e803f5);
          }
        }
...
var _default = {
  ...
  methods: {
    signInForm: function signInForm(page) {
      this.$emit('changePage', page);
    },
...
exports.default = _default;
        var $c6a022 = exports.default || module.exports;
      
      if (typeof $c6a022 === 'function') {
        $c6a022 = $c6a022.options;
      }
    
        /* template */
        Object.assign($c6a022, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _vm.currentPage === "signUp" && !_vm.isLogedIn
    ? _c("div", { staticClass: "p-2 m-3 form-sign-container" }, [
        _vm._m(0),
        _vm._v(" "),
        _c(
          ...
          [
            ...
            _c("div", { staticClass: "d-flex align-items-center" }, [
              _c(
                ...
                {
                  staticClass: "mr-2 btn btn-dark",
                  attrs: { id: "btn-signUp", type: "submit" }
                },
                [_vm._v("Sign up")]
              ),
              _vm._v(" "),
              _c(
                "p",
                {
                  staticClass: "mb-0 btn-to-signIn",
                  attrs: { id: "btn-to-signIn" },
                  on: {
                    click: function($event) {
                      return _vm.signInForm("signIn")
                    }
                  }
                },
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$c6a022', $c6a022);
          } else {
            api.reload('$c6a022', $c6a022);
          }
        }
...
var _default = {
  ...
  methods: {
    ...
    fetchCategoriesAfterAdd: function fetchCategoriesAfterAdd() {
    ...
    addCard: function addCard() {
      ...
      (0, _axios.default)({
        ...
        _this.$emit('fetchCategoriesAfterAdd');

        _this.$emit('closeAddForm');
      }).catch(function (err) {
        console.log(err.response.data);
      });
    }
    ...
    [
      ...
      _c(
        ...
        [
          ...
          _vm._v(" "),
          _c("div", { staticClass: "d-flex align-items-end add-form-action" }, [
            _c(
              "button",
              { staticClass: "mr-2 btn btn-dark", attrs: { type: "submit" } },
              [_vm._v("Add card")]
            ),
            _vm._v(" "),
            _c("p", { staticClass: "m-0", on: { click: _vm.closeAddForm } }, [
              _vm._v("cancel")
            ])
          ])
        ]
...
exports.default = _default;
        var $97f2c4 = exports.default || module.exports;
      
      if (typeof $97f2c4 === 'function') {
        $97f2c4 = $97f2c4.options;
      }
    
        /* template */
        Object.assign($97f2c4, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
      ...
      _c(
        ...
        [
          ...
          _c("div", { staticClass: "d-flex align-items-end add-form-action" }, [
            ...
            _vm._v(" "),
            _c("p", { staticClass: "m-0", on: { click: _vm.closeEditForm } }, [
              _vm._v("cancel")
            ])
          ])
        ]
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$97f2c4', $97f2c4);
          } else {
            api.reload('$97f2c4', $97f2c4);
          }
        }
...
var _default = {
  ...
  methods: {
    fetchCategories: function fetchCategories() {
      ...
      (0, _axios.default)({
          ...
          result.forEach(function (data) {
            ...
            if (data.name === 'Backlog') {
              if (data.Tasks.length) {
                ...
                _this.backlogs.sort(function (a, b) {
                  return a.id - b.id;
                });
              }
              ...
              if (data.Tasks.length) {
                ...
                _this.completes.sort(function (a, b) {
                  return a.id - b.id;
                });
              }
            }
        ...
        for (var i = 0; i < _this.categories.length; i++) {
          if (_this.categories[i].name === 'Backlog') {
            break;
          }

          if (i === _this.categories.length - 1) {
            _this.categories.push({
              id: 1,
              name: 'Backlog'
            });
        ...
        for (var _i = 0; _i < _this.categories.length; _i++) {
          if (_this.categories[_i].name === 'Todo') {
            break;
          }

          if (_i === _this.categories.length - 1) {
            _this.categories.push({
              id: 2,
              name: 'Todo'
            });
        ...
        for (var _i2 = 0; _i2 < _this.categories.length; _i2++) {
          if (_this.categories[_i2].name === 'Done') {
            break;
          }

          if (_i2 === _this.categories.length - 1) {
            _this.categories.push({
              id: 3,
              name: 'Done'
            });
        ...
        for (var _i3 = 0; _i3 < _this.categories.length; _i3++) {
          if (_this.categories[_i3].name === 'Complete') {
            break;
          }

          if (_i3 === _this.categories.length - 1) {
            _this.categories.push({
              id: 4,
              name: 'Complete'
            });
    ...
    addCardForm: function addCardForm(id) {
      this.categoryId = id;
    ...
    editCardForm: function editCardForm(id) {
      ...
      if (this.editCardFormUp) {
        ...
        (0, _axios.default)({
          ...
          var data = _ref2.data;
          var task = data.data;
          _this2.dataEdit = task;
          _this2.editCardFormUp = true;
        }).catch(function (err) {
          console.log(err.response.data);
        });
      }
  ...
  mounted: function mounted() {// addCardFormDown()
  }
};
exports.default = _default;
        var $f846f0 = exports.default || module.exports;
      
      if (typeof $f846f0 === 'function') {
        $f846f0 = $f846f0.options;
      }
    
        /* template */
        Object.assign($f846f0, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
      ...
      [
            ...
            [
              ...
              _c("div", { staticClass: "mt-2 add-card" }, [
                _c(
                  "p",
                  {
                    staticClass: "icon-add-card",
                    on: {
                      click: function($event) {
                        return _vm.addCardForm(category.id)
                      }
                    }
                  },
                  [
        ...
        _vm.addCardFormUp
          ? _c("AddCard", {
              ...
              on: {
                closeAddForm: _vm.addCardForm,
                changePage: _vm.changePage,
                fetchCategoriesAfterAdd: _vm.fetchCategories
              }
            })
          : _vm._e(),
        _vm._v(" "),
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$f846f0', $f846f0);
          } else {
            api.reload('$f846f0', $f846f0);
          }
        }
...
var _default = {
  ...
  methods: {
    ...
    changeIsLogedIn: function changeIsLogedIn(status) {
...
exports.default = _default;
        var $dab78c = exports.default || module.exports;
      
      if (typeof $dab78c === 'function') {
        $dab78c = $dab78c.options;
      }
    
        /* template */
        Object.assign($dab78c, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    ...
    [
      _c("Header", {
        attrs: { isLogedIn: _vm.isLogedIn },
        on: { changeIsLogedIn: _vm.changeIsLogedIn, changePage: _vm.changePage }
      }),
      _vm._v(" "),
      _c("SignIn", {
        attrs: { currentPage: _vm.currentPage, isLogedIn: _vm.isLogedIn },
        on: { changePage: _vm.changePage, changeIsLogedIn: _vm.changeIsLogedIn }
      }),
      _vm._v(" "),
      _c("SignUp", {
        attrs: { currentPage: _vm.currentPage, isLogedIn: _vm.isLogedIn },
      ...
      _vm._v(" "),
      _vm.currentPage === "board" || _vm.isLogedIn
        ? _c("Board", {
            attrs: { isLogedIn: _vm.isLogedIn },
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$dab78c', $dab78c);
          } else {
            api.reload('$dab78c', $dab78c);
          }
        }
