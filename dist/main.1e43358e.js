  ...
  methods: {
    ...
    renderEditTask: function renderEditTask(id) {
      ...
      axios({
        ...
        console.log(response.data.data);
        _this5.editTaskObj = response.data.data;
      }).catch(function (response) {
        _this5.response;
      });
    },
  ...
  return _c("div", [
    _c(
      ...
      [
            ...
            "a",
            {
              ...
              on: {
                click: function($event) {
                  ...
                  return _vm.showDashboard($event)
                }
              }
            },
            [_vm._v("KANBAN")]
        ...
        _c(
          "div",
          { staticClass: "navbar-menu", attrs: { id: "kanbanNavbar" } },
          [
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "37623" + '/');
